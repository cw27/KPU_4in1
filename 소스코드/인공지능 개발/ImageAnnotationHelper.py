...
class LabelTool():
    def __init__(self, master):
        ...
        self.cur_cls_id = -1
        self.parent = master
        self.parent.title("AnnotationHelper")
    ...
    def loadDir(self, dbg=False):
        ...
        # set up output dir
        if not os.path.exists('./images/annotated/train'):
            os.mkdir('./images/annotated/train')
        self.outDir = os.path.join(r'./images/annotated/train', '%s' % (self.category))
